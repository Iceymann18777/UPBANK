...
.method public synthetic thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$MethodComparator;->thenComparing(Lj$/util/function/Function;)Ljava/util/Comparator;
...
.method public synthetic thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/junit/runners/model/TestClass$MethodComparator;->thenComparing(Lj$/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public synthetic thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$MethodComparator;->thenComparingDouble(Lj$/util/function/ToDoubleFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$MethodComparator;->thenComparingInt(Lj$/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$MethodComparator;->thenComparingLong(Lj$/util/function/ToLongFunction;)Ljava/util/Comparator;
