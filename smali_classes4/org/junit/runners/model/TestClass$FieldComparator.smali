...
.method public synthetic thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$FieldComparator;->thenComparing(Lj$/util/function/Function;)Ljava/util/Comparator;
...
.method public synthetic thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/junit/runners/model/TestClass$FieldComparator;->thenComparing(Lj$/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public synthetic thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$FieldComparator;->thenComparingDouble(Lj$/util/function/ToDoubleFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$FieldComparator;->thenComparingInt(Lj$/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lorg/junit/runners/model/TestClass$FieldComparator;->thenComparingLong(Lj$/util/function/ToLongFunction;)Ljava/util/Comparator;
