...
.method protected pullFromSrc()I
    ...
    .line 52
    :cond_1
    iget-object v3, p0, Lorg/spongycastle/est/CTEBase64InputStream;->src:Ljava/io/InputStream;
    ...
    :cond_3
    :goto_0
    iget-object v4, p0, Lorg/spongycastle/est/CTEBase64InputStream;->rawBuf:[B
    ...
    iget-wide v4, p0, Lorg/spongycastle/est/CTEBase64InputStream;->read:J

    iget-object v6, p0, Lorg/spongycastle/est/CTEBase64InputStream;->max:Ljava/lang/Long;
    ...
    .line 79
    :try_start_0
    iget-object v1, p0, Lorg/spongycastle/est/CTEBase64InputStream;->rawBuf:[B

    iget-object v3, p0, Lorg/spongycastle/est/CTEBase64InputStream;->dataOutputStream:Ljava/io/OutputStream;

    invoke-static {v1, v0, v2, v3}, Lorg/spongycastle/util/encoders/Base64;->decode([BIILjava/io/OutputStream;)I
    :try_end_0
