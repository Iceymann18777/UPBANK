...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lnet/time4j/format/expert/TimezoneElement;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lnet/time4j/format/expert/TimezoneElement;->TIMEZONE_OFFSET:Lnet/time4j/format/expert/TimezoneElement;

    const/4 v3, 0x2

    new-array v3, v3, [Lnet/time4j/format/expert/TimezoneElement;
    ...
    .line 38
    sput-object v3, Lnet/time4j/format/expert/TimezoneElement;->$VALUES:[Lnet/time4j/format/expert/TimezoneElement;
...
.method public synthetic thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/format/expert/TimezoneElement;->thenComparing(Lj$/util/function/Function;)Ljava/util/Comparator;
...
.method public synthetic thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1, p2}, Lnet/time4j/format/expert/TimezoneElement;->thenComparing(Lj$/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public synthetic thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/format/expert/TimezoneElement;->thenComparingDouble(Lj$/util/function/ToDoubleFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/format/expert/TimezoneElement;->thenComparingInt(Lj$/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lnet/time4j/format/expert/TimezoneElement;->thenComparingLong(Lj$/util/function/ToLongFunction;)Ljava/util/Comparator;
