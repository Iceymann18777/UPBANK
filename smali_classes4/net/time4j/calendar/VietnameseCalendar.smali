...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lnet/time4j/calendar/VietnameseCalendar;->LEAP_MONTHS:[I

    .line 237
    new-instance v1, Lnet/time4j/calendar/service/StdIntegerDateElement;

    const-class v4, Lnet/time4j/calendar/VietnameseCalendar;
    ...
    .line 254
    sget-object v2, Lnet/time4j/calendar/EastAsianCY;->SINGLETON:Lnet/time4j/calendar/EastAsianCY;

    sput-object v2, Lnet/time4j/calendar/VietnameseCalendar;->YEAR_OF_CYCLE:Lnet/time4j/format/TextElement;
    ...
    sput-object v3, Lnet/time4j/calendar/VietnameseCalendar;->SOLAR_TERM:Lnet/time4j/engine/ChronoElement;

    .line 275
    sget-object v4, Lnet/time4j/calendar/EastAsianME;->SINGLETON_EA:Lnet/time4j/calendar/EastAsianME;

    sput-object v4, Lnet/time4j/calendar/VietnameseCalendar;->MONTH_OF_YEAR:Lnet/time4j/format/TextElement;

    .line 290
    new-instance v13, Lnet/time4j/calendar/service/StdIntegerDateElement;

    const-class v7, Lnet/time4j/calendar/VietnameseCalendar;

    const-string v6, "MONTH_AS_ORDINAL"
    ...
    sput-object v13, Lnet/time4j/calendar/VietnameseCalendar;->MONTH_AS_ORDINAL:Lnet/time4j/calendar/StdCalendarElement;

    .line 305
    new-instance v5, Lnet/time4j/calendar/service/StdIntegerDateElement;

    const-class v16, Lnet/time4j/calendar/VietnameseCalendar;

    const-string v15, "DAY_OF_MONTH"
    ...
    invoke-direct/range {v14 .. v19}, Lnet/time4j/calendar/service/StdIntegerDateElement;-><init>(Ljava/lang/String;Ljava/lang/Class;IIC)V
    ...
    sput-object v12, Lnet/time4j/calendar/VietnameseCalendar;->DAY_OF_YEAR:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v6, Lnet/time4j/calendar/VietnameseCalendar;->DAY_OF_WEEK:Lnet/time4j/calendar/StdCalendarElement;

    .line 340
    new-instance v7, Lnet/time4j/calendar/WeekdayInMonthElement;

    invoke-direct {v7, v0, v5, v6}, Lnet/time4j/calendar/WeekdayInMonthElement;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;)V

    sput-object v7, Lnet/time4j/calendar/VietnameseCalendar;->WIM_ELEMENT:Lnet/time4j/calendar/WeekdayInMonthElement;

    .line 350
    sput-object v7, Lnet/time4j/calendar/VietnameseCalendar;->WEEKDAY_IN_MONTH:Lnet/time4j/calendar/OrdinalWeekdayElement;

    .line 356
    new-instance v8, Lnet/time4j/calendar/VietnameseCalendar$Transformer;

    const/4 v9, 0x0

    invoke-direct {v8, v9}, Lnet/time4j/calendar/VietnameseCalendar$Transformer;-><init>(Lnet/time4j/calendar/VietnameseCalendar$1;)V

    sput-object v8, Lnet/time4j/calendar/VietnameseCalendar;->CALSYS:Lnet/time4j/calendar/EastAsianCS;

    .line 358
    const-class v9, Lnet/time4j/calendar/VietnameseCalendar$Unit;

    new-instance v10, Lnet/time4j/calendar/VietnameseCalendar$Merger;

    invoke-direct {v10}, Lnet/time4j/calendar/VietnameseCalendar$Merger;-><init>()V

    .line 359
    invoke-static {v9, v0, v10, v8}, Lnet/time4j/engine/TimeAxis$Builder;->setUp(Ljava/lang/Class;Ljava/lang/Class;Lnet/time4j/engine/ChronoMerger;Lnet/time4j/engine/CalendarSystem;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v9

    .line 366
    invoke-static {v2}, Lnet/time4j/calendar/EastAsianCalendar;->getCycleRule(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/engine/ElementRule;

    move-result-object v10

    .line 364
    invoke-virtual {v9, v1, v10}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v1

    .line 369
    invoke-static {v4}, Lnet/time4j/calendar/EastAsianCalendar;->getVietYearOfCycleRule(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/engine/ElementRule;

    move-result-object v9

    sget-object v10, Lnet/time4j/calendar/VietnameseCalendar$Unit;->YEARS:Lnet/time4j/calendar/VietnameseCalendar$Unit;

    .line 367
    invoke-virtual {v1, v2, v9, v10}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;Ljava/lang/Object;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    .line 371
    invoke-virtual {v1, v3, v2}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    sget-object v3, Lnet/time4j/calendar/VietnameseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    .line 378
    invoke-virtual {v1, v13, v2, v3}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;Ljava/lang/Object;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    sget-object v3, Lnet/time4j/calendar/VietnameseCalendar$Unit;->DAYS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    .line 386
    invoke-virtual {v1, v12, v2, v3}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;Ljava/lang/Object;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    new-instance v4, Lnet/time4j/calendar/VietnameseCalendar$1;

    invoke-direct {v4}, Lnet/time4j/calendar/VietnameseCalendar$1;-><init>()V
    ...
    invoke-direct {v3, v8, v12}, Lnet/time4j/calendar/RelatedGregorianYearRule;-><init>(Lnet/time4j/engine/CalendarSystem;Lnet/time4j/engine/ChronoElement;)V
    ...
    sget-object v14, Lnet/time4j/calendar/VietnameseCalendar$Unit;->CYCLES:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v1, Lnet/time4j/calendar/VietnameseCalendar$Unit;->CYCLES:Lnet/time4j/calendar/VietnameseCalendar$Unit;

    .line 411
    invoke-virtual {v1}, Lnet/time4j/calendar/VietnameseCalendar$Unit;->getLength()D

    move-result-wide v16

    sget-object v1, Lnet/time4j/calendar/VietnameseCalendar$Unit;->YEARS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v7, Lnet/time4j/calendar/VietnameseCalendar$Unit;->YEARS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v14, Lnet/time4j/calendar/VietnameseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v1, Lnet/time4j/calendar/VietnameseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v7, Lnet/time4j/calendar/VietnameseCalendar$Unit;->WEEKS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v1, Lnet/time4j/calendar/VietnameseCalendar$Unit;->WEEKS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v1, Lnet/time4j/calendar/VietnameseCalendar$Unit;->DAYS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    sget-object v14, Lnet/time4j/calendar/VietnameseCalendar$Unit;->DAYS:Lnet/time4j/calendar/VietnameseCalendar$Unit;
    ...
    invoke-direct {v2, v0, v5, v12, v3}, Lnet/time4j/calendar/CommonElements$Weekengine;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;Lnet/time4j/Weekmodel;)V
