...
.method static constructor <clinit>()V
    ...
    const-wide v3, 0x417e1854d1d14e3bL    # 3.1556941113599997E7

    invoke-direct {v0, v1, v2, v3, v4}, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;-><init>(Ljava/lang/String;ID)V
    ...
    invoke-direct {v1, v3, v4, v5, v6}, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;-><init>(Ljava/lang/String;ID)V
    ...
    const-wide v7, 0x412a5e0000000000L    # 864000.0

    invoke-direct {v3, v5, v6, v7, v8}, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;-><init>(Ljava/lang/String;ID)V

    sput-object v3, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;->DECADES:Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;

    .line 1397
    new-instance v5, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;
    ...
    invoke-direct {v5, v7, v8, v9, v10}, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;-><init>(Ljava/lang/String;ID)V

    sput-object v5, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;->WEEKS:Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;

    .line 1405
    new-instance v7, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;
    ...
    invoke-direct {v7, v9, v10, v11, v12}, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;-><init>(Ljava/lang/String;ID)V

    sput-object v7, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;->DAYS:Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;

    const/4 v9, 0x5

    new-array v9, v9, [Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;
    ...
    .line 1345
    sput-object v9, Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;->$VALUES:[Lnet/time4j/calendar/frenchrev/FrenchRepublicanCalendar$Unit;
