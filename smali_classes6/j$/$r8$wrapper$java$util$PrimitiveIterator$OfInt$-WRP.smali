.class public final synthetic Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-WRP;
...
.method private synthetic constructor <init>(Lj$/util/PrimitiveIterator$OfInt;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-WRP;->wrappedValue:Lj$/util/PrimitiveIterator$OfInt;
...
.method public static synthetic convert(Lj$/util/PrimitiveIterator$OfInt;)Ljava/util/PrimitiveIterator$OfInt;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-V-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-V-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-V-WRP;->wrappedValue:Ljava/util/PrimitiveIterator$OfInt;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-WRP;-><init>(Lj$/util/PrimitiveIterator$OfInt;)V
...
.method public synthetic forEachRemaining(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfInt$-WRP;->wrappedValue:Lj$/util/PrimitiveIterator$OfInt;
