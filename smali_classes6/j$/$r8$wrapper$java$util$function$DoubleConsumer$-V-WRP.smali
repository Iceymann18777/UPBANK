.class public final synthetic Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-V-WRP;
...
.method private synthetic constructor <init>(Ljava/util/function/DoubleConsumer;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-V-WRP;->wrappedValue:Ljava/util/function/DoubleConsumer;
...
.method public static synthetic convert(Ljava/util/function/DoubleConsumer;)Lj$/util/function/DoubleConsumer;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-WRP;->wrappedValue:Lj$/util/function/DoubleConsumer;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-V-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-V-WRP;-><init>(Ljava/util/function/DoubleConsumer;)V
...
.method public synthetic accept(D)V
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$function$DoubleConsumer$-V-WRP;->wrappedValue:Ljava/util/function/DoubleConsumer;
