...
# instance fields
.field final synthetic wrappedValue:Ljava/util/function/BiFunction;
...
.method private synthetic constructor <init>(Ljava/util/function/BiFunction;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-V-WRP;->wrappedValue:Ljava/util/function/BiFunction;
...
.method public static synthetic convert(Ljava/util/function/BiFunction;)Lj$/util/function/BiFunction;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;->wrappedValue:Lj$/util/function/BiFunction;
...
.method public synthetic andThen(Lj$/util/function/Function;)Lj$/util/function/BiFunction;
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-V-WRP;->wrappedValue:Ljava/util/function/BiFunction;
