.class public final synthetic Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;
...
.method private synthetic constructor <init>(Lj$/util/function/BiFunction;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;->wrappedValue:Lj$/util/function/BiFunction;
...
.method public static synthetic convert(Lj$/util/function/BiFunction;)Ljava/util/function/BiFunction;
    ...
    iget-object p0, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-V-WRP;->wrappedValue:Ljava/util/function/BiFunction;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;-><init>(Lj$/util/function/BiFunction;)V
...
.method public synthetic andThen(Ljava/util/function/Function;)Ljava/util/function/BiFunction;
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$function$BiFunction$-WRP;->wrappedValue:Lj$/util/function/BiFunction;
