.class public final synthetic Lj$/$r8$wrapper$java$util$Spliterator$-V-WRP;
...
.method private synthetic constructor <init>(Ljava/util/Spliterator;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$Spliterator$-V-WRP;->wrappedValue:Ljava/util/Spliterator;
...
.method public static synthetic convert(Ljava/util/Spliterator;)Lj$/util/Spliterator;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$Spliterator$-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$Spliterator$-WRP;->wrappedValue:Lj$/util/Spliterator;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$Spliterator$-V-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$Spliterator$-V-WRP;-><init>(Ljava/util/Spliterator;)V
...
.method public synthetic characteristics()I
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$-V-WRP;->wrappedValue:Ljava/util/Spliterator;
