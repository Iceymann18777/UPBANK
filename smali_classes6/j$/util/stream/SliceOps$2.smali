...
.method opEvaluateParallel(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    iget-wide v12, v9, Lj$/util/stream/SliceOps$2;->val$skip:J

    iget-wide v14, v9, Lj$/util/stream/SliceOps$2;->val$limit:J
    ...
    .line 8
    invoke-static {v9, v0, v8}, Lj$/util/stream/Nodes;->collectInt(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfInt;
...
.method opEvaluateParallelLazy(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v1, v9, Lj$/util/stream/SliceOps$2;->val$limit:J
    ...
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/StreamSpliterators$SliceSpliterator$OfInt;-><init>(Lj$/util/Spliterator$OfInt;JJ)V
    ...
    sget-object v4, Lj$/util/stream/-$$Lambda$SliceOps$2$WFEYFFKt4sp2NB_Sd74HGm5dFis;->INSTANCE:Lj$/util/stream/-$$Lambda$SliceOps$2$WFEYFFKt4sp2NB_Sd74HGm5dFis;
...
.method unorderedSkipLimitSpliterator(Lj$/util/Spliterator$OfInt;JJJ)Lj$/util/Spliterator$OfInt;
    ...
    invoke-direct/range {p2 .. p7}, Lj$/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfInt;-><init>(Lj$/util/Spliterator$OfInt;JJ)V
