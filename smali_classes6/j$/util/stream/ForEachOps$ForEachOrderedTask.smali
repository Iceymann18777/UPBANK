...
.method public final compute()V
    ...
    .line 17
    sget-object v1, Lj$/util/stream/-$$Lambda$ForEachOps$ForEachOrderedTask$2322FFDvPTsaro4VGNeMYL3ySVU;->INSTANCE:Lj$/util/stream/-$$Lambda$ForEachOps$ForEachOrderedTask$2322FFDvPTsaro4VGNeMYL3ySVU;

    .line 18
    iget-object v2, v4, Lj$/util/stream/ForEachOps$ForEachOrderedTask;->helper:Lj$/util/stream/PipelineHelper;
    ...
    .line 20
    invoke-virtual {v2, v5, v6, v1}, Lj$/util/stream/PipelineHelper;->makeNodeBuilder(JLj$/util/function/IntFunction;)Lj$/util/stream/Node$Builder;
    ...
    check-cast v2, Lj$/util/stream/AbstractPipeline;
    ...
    .line 24
    invoke-virtual {v2, v1}, Lj$/util/stream/AbstractPipeline;->wrapSink(Lj$/util/stream/Sink;)Lj$/util/stream/Sink;

    move-result-object v3

    invoke-virtual {v2, v3, v0}, Lj$/util/stream/AbstractPipeline;->copyInto(Lj$/util/stream/Sink;Lj$/util/Spliterator;)V
...
.method public onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    check-cast v1, Lj$/util/stream/AbstractPipeline;
    ...
    .line 8
    invoke-virtual {v1, v2}, Lj$/util/stream/AbstractPipeline;->wrapSink(Lj$/util/stream/Sink;)Lj$/util/stream/Sink;

    move-result-object v2

    invoke-virtual {v1, v2, p1}, Lj$/util/stream/AbstractPipeline;->copyInto(Lj$/util/stream/Sink;Lj$/util/Spliterator;)V
