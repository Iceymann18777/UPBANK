.class public final synthetic Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;
...
.method private synthetic constructor <init>(Lj$/util/Spliterator$OfPrimitive;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;->wrappedValue:Lj$/util/Spliterator$OfPrimitive;
...
.method public static synthetic convert(Lj$/util/Spliterator$OfPrimitive;)Ljava/util/Spliterator$OfPrimitive;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;->wrappedValue:Ljava/util/Spliterator$OfPrimitive;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;-><init>(Lj$/util/Spliterator$OfPrimitive;)V
...
.method public synthetic characteristics()I
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;->wrappedValue:Lj$/util/Spliterator$OfPrimitive;
