.class public final synthetic Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-V-WRP;
...
# instance fields
.field final synthetic wrappedValue:Ljava/util/PrimitiveIterator$OfLong;
...
.method private synthetic constructor <init>(Ljava/util/PrimitiveIterator$OfLong;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-V-WRP;->wrappedValue:Ljava/util/PrimitiveIterator$OfLong;
...
.method public static synthetic convert(Ljava/util/PrimitiveIterator$OfLong;)Lj$/util/PrimitiveIterator$OfLong;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-WRP;->wrappedValue:Lj$/util/PrimitiveIterator$OfLong;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-V-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-V-WRP;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
...
.method public synthetic forEachRemaining(Lj$/util/function/Consumer;)V
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$PrimitiveIterator$OfLong$-V-WRP;->wrappedValue:Ljava/util/PrimitiveIterator$OfLong;
