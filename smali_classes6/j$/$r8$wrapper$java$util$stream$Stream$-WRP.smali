.class public final synthetic Lj$/$r8$wrapper$java$util$stream$Stream$-WRP;
...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$stream$Stream$-WRP;->wrappedValue:Lj$/util/stream/Stream;
...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$stream$Stream$-V-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$stream$Stream$-V-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$stream$Stream$-V-WRP;->wrappedValue:Ljava/util/stream/Stream;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$stream$Stream$-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$stream$Stream$-WRP;-><init>(Lj$/util/stream/Stream;)V
...
.method public synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$stream$Stream$-WRP;->wrappedValue:Lj$/util/stream/Stream;
...
.method public synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/$r8$wrapper$java$util$function$BiConsumer$-V-WRP;->convert(Ljava/util/function/BiConsumer;)Lj$/util/function/BiConsumer;
...
.method public synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/$r8$wrapper$java$util$stream$Collector$-V-WRP;->convert(Ljava/util/stream/Collector;)Lj$/util/stream/Collector;
...
.method public synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/time/Clock$OffsetClock-$$ExternalSynthetic0;->convert(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/time/Clock$OffsetClock-$$ExternalSynthetic0;->convert(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/$r8$wrapper$java$util$function$BinaryOperator$-V-WRP;->convert(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/$r8$wrapper$java$util$function$BinaryOperator$-V-WRP;->convert(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;
...
.method public synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/$r8$wrapper$java$util$function$BinaryOperator$-V-WRP;->convert(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;
