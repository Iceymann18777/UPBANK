.class public final synthetic Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;
...
# instance fields
.field final synthetic wrappedValue:Ljava/util/Spliterator$OfPrimitive;
...
.method private synthetic constructor <init>(Ljava/util/Spliterator$OfPrimitive;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;->wrappedValue:Ljava/util/Spliterator$OfPrimitive;
...
.method public static synthetic convert(Ljava/util/Spliterator$OfPrimitive;)Lj$/util/Spliterator$OfPrimitive;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-WRP;->wrappedValue:Lj$/util/Spliterator$OfPrimitive;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;-><init>(Ljava/util/Spliterator$OfPrimitive;)V
...
.method public synthetic characteristics()I
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfPrimitive$-V-WRP;->wrappedValue:Ljava/util/Spliterator$OfPrimitive;
