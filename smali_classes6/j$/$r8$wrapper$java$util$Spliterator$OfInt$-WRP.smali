.class public final synthetic Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-WRP;
...
# instance fields
.field final synthetic wrappedValue:Lj$/util/Spliterator$OfInt;
...
.method private synthetic constructor <init>(Lj$/util/Spliterator$OfInt;)V
    ...
    iput-object p1, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-WRP;->wrappedValue:Lj$/util/Spliterator$OfInt;
...
.method public static synthetic convert(Lj$/util/Spliterator$OfInt;)Ljava/util/Spliterator$OfInt;
    ...
    :cond_0
    instance-of v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-V-WRP;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-V-WRP;

    iget-object p0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-V-WRP;->wrappedValue:Ljava/util/Spliterator$OfInt;

    return-object p0

    :cond_1
    new-instance v0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-WRP;

    invoke-direct {v0, p0}, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-WRP;-><init>(Lj$/util/Spliterator$OfInt;)V
...
.method public synthetic characteristics()I
    ...
    iget-object v0, p0, Lj$/$r8$wrapper$java$util$Spliterator$OfInt$-WRP;->wrappedValue:Lj$/util/Spliterator$OfInt;
