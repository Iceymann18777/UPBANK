.class final Lcom/google/android/gms/internal/firebase_ml/zzwf;
...
.method public final synthetic compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    .line 3
    invoke-virtual {p1}, Lcom/google/android/gms/internal/firebase_ml/zzwd;->iterator()Ljava/util/Iterator;
    ...
    .line 4
    invoke-virtual {p2}, Lcom/google/android/gms/internal/firebase_ml/zzwd;->iterator()Ljava/util/Iterator;

    move-result-object v1

    check-cast v1, Lcom/google/android/gms/internal/firebase_ml/zzwi;

    .line 5
    :cond_0
    invoke-interface {v0}, Lcom/google/android/gms/internal/firebase_ml/zzwi;->hasNext()Z
    ...
    invoke-static {v2}, Lcom/google/android/gms/internal/firebase_ml/zzwd;->zzc(B)I

    move-result v2

    invoke-interface {v1}, Lcom/google/android/gms/internal/firebase_ml/zzwi;->nextByte()B

    move-result v3

    invoke-static {v3}, Lcom/google/android/gms/internal/firebase_ml/zzwd;->zzc(B)I
...
.method public synthetic thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/internal/firebase_ml/zzwf;->thenComparing(Lj$/util/function/Function;)Ljava/util/Comparator;
...
.method public synthetic thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/internal/firebase_ml/zzwf;->thenComparing(Lj$/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public synthetic thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/internal/firebase_ml/zzwf;->thenComparingDouble(Lj$/util/function/ToDoubleFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/internal/firebase_ml/zzwf;->thenComparingInt(Lj$/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/internal/firebase_ml/zzwf;->thenComparingLong(Lj$/util/function/ToLongFunction;)Ljava/util/Comparator;
