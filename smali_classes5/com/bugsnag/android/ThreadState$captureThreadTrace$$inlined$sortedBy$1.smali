.class public final Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/bugsnag/android/ThreadState;->captureThreadTrace(Ljava/util/Map;Ljava/lang/Thread;Ljava/lang/Throwable;ZLjava/util/Collection;Lcom/bugsnag/android/Logger;)Ljava/util/List;
.end annotation
...
.method public synthetic thenComparing(Ljava/util/function/Function;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;->thenComparing(Lj$/util/function/Function;)Ljava/util/Comparator;
...
.method public synthetic thenComparing(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;->thenComparing(Lj$/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;
...
.method public synthetic thenComparingDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;->thenComparingDouble(Lj$/util/function/ToDoubleFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingInt(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;->thenComparingInt(Lj$/util/function/ToIntFunction;)Ljava/util/Comparator;
...
.method public synthetic thenComparingLong(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;
    ...
    invoke-virtual {p0, p1}, Lcom/bugsnag/android/ThreadState$captureThreadTrace$$inlined$sortedBy$1;->thenComparingLong(Lj$/util/function/ToLongFunction;)Ljava/util/Comparator;
