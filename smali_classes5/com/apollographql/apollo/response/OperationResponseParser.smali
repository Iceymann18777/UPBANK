...
.field final responseFieldMapper:Lcom/apollographql/apollo/api/internal/ResponseFieldMapper;

.field final responseNormalizer:Lcom/apollographql/apollo/cache/normalized/internal/ResponseNormalizer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lcom/apollographql/apollo/api/Operation;Lcom/apollographql/apollo/api/internal/ResponseFieldMapper;Lcom/apollographql/apollo/api/ScalarTypeAdapters;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static parseErrorLocation(Ljava/util/Map;)Lcom/apollographql/apollo/api/Error$Location;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private readResponseErrors(Lcom/apollographql/apollo/api/internal/json/ResponseJsonStreamReader;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public parse(Ljava/util/Map;)Lcom/apollographql/apollo/api/Response;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1}, Lcom/apollographql/apollo/api/Operation;->variables()Lcom/apollographql/apollo/api/Operation$Variables;

    move-result-object v2

    new-instance v4, Lcom/apollographql/apollo/internal/field/MapFieldValueResolver;

    invoke-direct {v4}, Lcom/apollographql/apollo/internal/field/MapFieldValueResolver;-><init>()V

    iget-object v5, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->scalarTypeAdapters:Lcom/apollographql/apollo/api/ScalarTypeAdapters;

    iget-object v6, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->responseNormalizer:Lcom/apollographql/apollo/cache/normalized/internal/ResponseNormalizer;
    ...
    .line 55
    iget-object v1, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->responseFieldMapper:Lcom/apollographql/apollo/api/internal/ResponseFieldMapper;

    invoke-interface {v1, v7}, Lcom/apollographql/apollo/api/internal/ResponseFieldMapper;->map(Lcom/apollographql/apollo/api/internal/ResponseReader;)Ljava/lang/Object;
    ...
    .line 64
    invoke-static {v3}, Lcom/apollographql/apollo/response/OperationResponseParser;->parseError(Ljava/util/Map;)Lcom/apollographql/apollo/api/Error;
    ...
    .line 69
    :cond_1
    iget-object v2, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->operation:Lcom/apollographql/apollo/api/Operation;

    invoke-static {v2}, Lcom/apollographql/apollo/api/Response;->builder(Lcom/apollographql/apollo/api/Operation;)Lcom/apollographql/apollo/api/Response$Builder;

    move-result-object v2

    iget-object v3, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->operation:Lcom/apollographql/apollo/api/Operation;

    .line 70
    invoke-interface {v3, v1}, Lcom/apollographql/apollo/api/Operation;->wrapData(Lcom/apollographql/apollo/api/Operation$Data;)Ljava/lang/Object;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcom/apollographql/apollo/api/Response$Builder;->data(Ljava/lang/Object;)Lcom/apollographql/apollo/api/Response$Builder;

    move-result-object v1

    .line 71
    invoke-virtual {v1, v0}, Lcom/apollographql/apollo/api/Response$Builder;->errors(Ljava/util/List;)Lcom/apollographql/apollo/api/Response$Builder;

    move-result-object v0

    iget-object v1, p0, Lcom/apollographql/apollo/response/OperationResponseParser;->responseNormalizer:Lcom/apollographql/apollo/cache/normalized/internal/ResponseNormalizer;

    .line 72
    invoke-virtual {v1}, Lcom/apollographql/apollo/cache/normalized/internal/ResponseNormalizer;->dependentKeys()Ljava/util/Set;
    ...
    invoke-virtual {v0, p1}, Lcom/apollographql/apollo/api/Response$Builder;->extensions(Ljava/util/Map;)Lcom/apollographql/apollo/api/Response$Builder;
...
.method public parse(Lokio/BufferedSource;)Lcom/apollographql/apollo/api/Response;
    ...
    .line 101
    invoke-direct {p0, p1}, Lcom/apollographql/apollo/response/OperationResponseParser;->readResponseErrors(Lcom/apollographql/apollo/api/internal/json/ResponseJsonStreamReader;)Ljava/util/List;
