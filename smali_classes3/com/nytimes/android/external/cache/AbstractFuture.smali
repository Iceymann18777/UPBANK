...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/nytimes/android/external/cache/AbstractFuture;->GENERATE_CANCELLATION_CAUSES:Z
    ...
    sput-object v1, Lcom/nytimes/android/external/cache/AbstractFuture;->log:Ljava/util/logging/Logger;

    .line 77
    :try_start_0
    new-instance v1, Lcom/nytimes/android/external/cache/AbstractFuture$SafeAtomicHelper;

    const-class v2, Lcom/nytimes/android/external/cache/AbstractFuture$Waiter;
    ...
    const-class v2, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/nytimes/android/external/cache/AbstractFuture$SafeAtomicHelper;-><init>(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;)V
    :try_end_0
    ...
    .line 90
    new-instance v1, Lcom/nytimes/android/external/cache/AbstractFuture$SynchronizedHelper;

    const/4 v0, 0x0

    invoke-direct {v1, v0}, Lcom/nytimes/android/external/cache/AbstractFuture$SynchronizedHelper;-><init>(Lcom/nytimes/android/external/cache/AbstractFuture$1;)V

    .line 93
    :goto_0
    sput-object v1, Lcom/nytimes/android/external/cache/AbstractFuture;->ATOMIC_HELPER:Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;
...
.method private complete()V
    ...
    .line 715
    iget-object v2, v0, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;->next:Lcom/nytimes/android/external/cache/AbstractFuture$Listener;

    .line 716
    iput-object v1, v0, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;->next:Lcom/nytimes/android/external/cache/AbstractFuture$Listener;
    ...
    .line 720
    iget-object v0, v1, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;->task:Ljava/lang/Runnable;

    iget-object v2, v1, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;->executor:Ljava/util/concurrent/Executor;

    invoke-static {v0, v2}, Lcom/nytimes/android/external/cache/AbstractFuture;->executeListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    .line 719
    iget-object v1, v1, Lcom/nytimes/android/external/cache/AbstractFuture$Listener;->next:Lcom/nytimes/android/external/cache/AbstractFuture$Listener;
...
.method private completeWithFuture(Lcom/nytimes/android/external/cache/ListenableFuture;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, p0, p2, p1}, Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;->casValue(Lcom/nytimes/android/external/cache/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method protected setFuture(Lcom/nytimes/android/external/cache/ListenableFuture;)Z
    .locals 3
    .param p1    # Lcom/nytimes/android/external/cache/ListenableFuture;
        .annotation runtime Ljavax/annotation/Nonnull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 633
    invoke-direct {p0, p1, v1}, Lcom/nytimes/android/external/cache/AbstractFuture;->completeWithFuture(Lcom/nytimes/android/external/cache/ListenableFuture;Ljava/lang/Object;)Z
    ...
    .line 635
    :cond_0
    new-instance v0, Lcom/nytimes/android/external/cache/AbstractFuture$SetFuture;

    invoke-direct {v0, p0, p1}, Lcom/nytimes/android/external/cache/AbstractFuture$SetFuture;-><init>(Lcom/nytimes/android/external/cache/AbstractFuture;Lcom/nytimes/android/external/cache/ListenableFuture;)V

    .line 636
    sget-object v2, Lcom/nytimes/android/external/cache/AbstractFuture;->ATOMIC_HELPER:Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;

    invoke-virtual {v2, p0, v1, v0}, Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;->casValue(Lcom/nytimes/android/external/cache/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v0, v1}, Lcom/nytimes/android/external/cache/ListenableFuture;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 649
    :catchall_1
    sget-object v1, Lcom/nytimes/android/external/cache/AbstractFuture$Failure;->FALLBACK_INSTANCE:Lcom/nytimes/android/external/cache/AbstractFuture$Failure;

    .line 652
    :goto_0
    sget-object p1, Lcom/nytimes/android/external/cache/AbstractFuture;->ATOMIC_HELPER:Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;

    invoke-virtual {p1, p0, v0, v1}, Lcom/nytimes/android/external/cache/AbstractFuture$AtomicHelper;->casValue(Lcom/nytimes/android/external/cache/AbstractFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v0}, Lcom/nytimes/android/external/cache/ListenableFuture;->cancel(Z)Z
